  ...
  <div>
    ...
    <div class="box-content">
      <div class="box-content-top">
        <!-- 课程开课总览 -->
        <div class="box-item">
          <div class="box-item-title">课程开展总览</div>
        ...
        <!-- 各类课程开课情况 -->
        <div class="box-item">
          <div class="box-item-title">各类课程开课情况</div>
          <!-- <span class="scope_label">学院范围</span>
                     <select name="" id="" class="scope_select">
      ...
      <div class="box-content-bottom">
          <!-- 各单位课程供给排行 -->
        <div class="box-item">
          <div class="box-item-title">各单位课程供给排行</div>
          <div data-v-6fb7acda class="fxbox4-contant">
            <div data-v-6fb7acda class="fxbox4-li">
              <div data-v-6fb7acda class="fxbox4-litit fxbox1-new-span">外语学院</div>
              <div data-v-6fb7acda class="fxbox4-lidiv">
                <div data-v-6fb7acda class="fxbox4-div1">
                  &nbsp;&nbsp;
                  <span data-v-6fb7acda class="iconfont icon-ketang"></span>&nbsp;
                  <span data-v-6fb7acda>856</span>次&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  <span data-v-6fb7acda class="iconfont icon-rengong-copy"></span>&nbsp;
                  <span data-v-6fb7acda>373</span>人次
                </div>
                <div data-v-6fb7acda class="fxbox4-div2" style="width: 100%;"></div>
                <div data-v-6fb7acda class="fxbox4-div3" style="width: 100%;"></div>
              </div>
            </div>
            <div data-v-6fb7acda class="fxbox4-li">
              <div data-v-6fb7acda class="fxbox4-litit fxbox1-new-span">经济学院保险系1212</div>
              <div data-v-6fb7acda class="fxbox4-lidiv">
                <div data-v-6fb7acda class="fxbox4-div1">
                  &nbsp;&nbsp;
                  <span data-v-6fb7acda class="iconfont icon-ketang"></span>&nbsp;
                  <span data-v-6fb7acda>434</span>次&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  <span data-v-6fb7acda class="iconfont icon-rengong-copy"></span>&nbsp;
                  <span data-v-6fb7acda>296</span>人次
                </div>
                <div data-v-6fb7acda class="fxbox4-div2" style="width: 50%;"></div>
                <div data-v-6fb7acda class="fxbox4-div3" style="width: 80%;"></div>
              </div>
            </div>
          </div>
        </div>
        <!-- 课程开展分时情况 -->
        <div class="box-item">
            <div class="box-item-title">课程开展分时情况</div>
...
/* 各单位课程供给排行 */
.fxbox4-contant[data-v-6fb7acda] {
    height: 80%;
    padding: 0 10px;
    margin-top: 10px;
}
.fxbox4-li[data-v-6fb7acda] {
    display: flex;
    width: 100%;
    height: 13%;
    background: #274155;
...
.fxbox4-div2[data-v-6fb7acda] {
    width: 50%;
    height: 0.10rem;
    background: #00c5ff;
}
.fxbox4-div3[data-v-6fb7acda] {
    width: 17%;
    height: 0.10rem;
    background: #8942bf;
    margin-top: .5%;
